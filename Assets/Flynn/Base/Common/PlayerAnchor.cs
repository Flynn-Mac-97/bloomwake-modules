...
{
    /// <summary>
    /// Runtime handle to the player's Transform. <see cref="PlayerController2D"/> sets this
    /// on enable via its _anchor field. Lets runtime-spawned objects (dropped items flying to the
