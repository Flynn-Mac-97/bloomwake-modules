...
namespace Flynn.World
{
    ...
    public class ItemDropArc : MonoBehaviour
    {
        ...
        [Tooltip("Sorting layer the item is forced onto while it is in the air.")]
        [SerializeField] private string _flightSortingLayer = "Default";
        ...
        public void BeginArc(Vector3 origin)
        {
            ...
            foreach (var sr in _renderers)
            {
                if (sr != null)
                {
                    sr.sortingLayerName = _flightSortingLayer;
        ...
        private void Collect()
        {
            ...
            {
                ItemReceiver.Current?.TryAddItem(def, _item.Count);
            }
