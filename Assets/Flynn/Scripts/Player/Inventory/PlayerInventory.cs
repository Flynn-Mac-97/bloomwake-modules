...
namespace Flynn.Player
{
    ...
    public class PlayerInventory : MonoBehaviour, IItemReceiver, Flynn.Npc.IDialogueInventory
    {
        ...
        private void Awake()
        {
            ...
            Instance = this;
            // The base layer hands picked-up items over through this seam; it cannot see
            // PlayerInventory itself.
            ItemReceiver.Current = this;
            // Dialogue lists what you carry so you can show or gift it; it sees only the
            // IDialogueInventory face, never this class.
            Flynn.Npc.DialogueHost.Inventory = this;
        ...
        private void OnDestroy()
        {
            ...
            if (ReferenceEquals(ItemReceiver.Current, this)) ItemReceiver.Current = null;
            if (ReferenceEquals(Flynn.Npc.DialogueHost.Inventory, this)) Flynn.Npc.DialogueHost.Inventory = null;
        }

        // ── IDialogueInventory ────────────────────────────────────────────────
        // The dialogue panel's view of the bag. Deliberately narrow: it can list and it can
        // take, and the wrench rule stays here rather than dialogue hard-coding slot 0.

        bool Flynn.Npc.IDialogueInventory.TryGetSlot(int index, out ItemDefinition item, out int count)
        {
            item = null; count = 0;
        ...
        bool Flynn.Npc.IDialogueInventory.IsGiftableSlot(int index) => index != WrenchSlot;
